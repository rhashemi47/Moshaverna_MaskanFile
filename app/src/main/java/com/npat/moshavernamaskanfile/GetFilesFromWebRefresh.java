...
public class GetFilesFromWebRefresh {
	...
	//Contractor
	public GetFilesFromWebRefresh(Activity activity, String StartPage, String EndPage , String WhereStr) {
    ...
    {
		PublicVariable.Content_Files = WsResponse;
	}
}
